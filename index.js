...
class bank {
    ...
    constructor(name, Emails, contact_number, account_type, fatherName, cnic, age, gender) {
    ...
    ;
    transfer_amount(amount, reciver) {
        if (this.balance > amount) {
            this.balance = this.balance - amount;
...
class bank_managment {
    manage = [];
    add_account(name, Emails, contact_number, account_type, fatherName, cnic, age, gender) {
    ...
    ;
    transfer_amount(sender, reciever, amount) {
